...
MERGE INTO t_service (id, name, caption, mode, driver_class, max_connections, type_name) KEY (id)
    VALUES (110, 'modbus_svc_hvac', 'Modbus TCP-HVAC模拟',  0, 'com.systar.monitor.drivers.modbus.ModbusService',    5, 'ModbusTcpMaster'),
...
MERGE INTO t_device (id, name, caption, catalog, vendor, purchase_date, warranty_date, health_index) KEY (id)
    VALUES (1101, 'ahu_sim_01',     'AHU空调机组模拟',  206, 'Simulator', '2026-01-01 00:00:00', '2030-01-01', 1.00),
